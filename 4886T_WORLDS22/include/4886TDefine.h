...
#define SlapperButton (Controller1.ButtonUp.pressing())
...
#define SlapRingsAuton 5
#define SlapNeutralAuton 6
#define FakeOutAuton 7
#define DebugAuton 8
#define SkillsAuton 9
#define LeastAuton AWPlineAuton
#define GreatestAuton SkillsAuton

#define WHEEL_TO_WHEEL_DIST 12
#define GYRO_DELAY 100
...
#define REAR_BLUE_MOGO Vision__SIG_1
#define REAR_RED_MOGO Vision__SIG_2
#define REAR_YELLOW_MOGO Vision__SIG_3
#define FRONT_BLUE_MOGO FrontVision__SIG_1
#define FRONT_RED_MOGO FrontVision__SIG_2
#define FRONT_YELLOW_MOGO FrontVision__SIG_3
#define REAR_GOAL_PRIMED 159
#define FRONT_GOAL_PRIMED 195
#define BLUE_SIDE 1
...
int FindMogo(int side, int spd, int maxDist = 144);
int FindFrontMogo(int side, int spd, int maxDist = 144);
